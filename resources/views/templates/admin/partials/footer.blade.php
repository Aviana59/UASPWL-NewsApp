...
<script src=" {{ url('sbadmin/vendor/bootstrap/js/bootstrap.bundle.min')}}.js">
</script>
...
< src="{{ url('sbadmin/js/demo/datatables-demo.js"></')}}script>

<!-- Core plugin JavaScript-->
    <script src=" {{ url('sbadmin/vendor/jquery-easing/jquery.easing.min')}}.js">
    </script>
